/**
 * travel-policy.html: плавный скролл, мобильное меню, .reveal, табы travel-policy
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('travel-policy-page')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.travel-policy-page .reveal').forEach(function (el) {
  ...
  (function initTravelPolicyTabs() {
    var root = document.querySelector('.travel-policy-page .travel-policy-tabs');
    if (!root) return;
