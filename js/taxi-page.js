/**
 * taxi.html: плавный скролл, закрытие мобильного меню, появление секций .reveal
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('taxi-page')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.taxi-page .reveal').forEach(function (el) {
