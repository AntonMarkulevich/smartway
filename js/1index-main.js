/**
 * Главная 1index.html: плавный скролл по якорям, закрытие мобильного меню (drawer),
 * появление секций .reveal (IntersectionObserver). Меню — нативный чекбокс + CSS;
 * FAQ — нативные <details>; отдельных модалок на странице нет.
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('page-1index')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.page-1index .reveal').forEach(function (el) {
