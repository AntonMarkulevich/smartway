/**
 * contacts.html: плавный скролл по якорям, закрытие мобильного меню, scroll-reveal (.reveal)
 */
(function () {
  'use strict';
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.page-contacts .reveal').forEach(function (el) {
