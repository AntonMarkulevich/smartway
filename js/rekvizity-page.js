/**
 * rekvizity.html: плавный скролл по якорям, закрытие мобильного меню, .reveal по скроллу
 * (чекбокс #site-nav + .header__drawer — как в site-header.css)
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('page-rekvizity')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.page-rekvizity .reveal').forEach(function (el) {
