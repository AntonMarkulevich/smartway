/**
 * superviser.html: плавный скролл по якорям, мобильное меню (чекбокс), появление .reveal
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('superviser-page')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.superviser-page .reveal').forEach(function (el) {
