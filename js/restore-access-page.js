/**
 * restore-access.html: плавный скролл, закрытие мобильного меню, .reveal по скроллу
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('restore-access-page')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.restore-access-page .reveal').forEach(function (el) {
