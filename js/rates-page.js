/**
 * rates.html: плавный скролл по якорям, закрытие мобильного меню, появление .reveal.
 * FAQ — нативные <details>; отдельных модалок на странице нет.
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('page-rates')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.page-rates .reveal').forEach(function (el) {
