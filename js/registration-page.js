/**
 * registration.html: плавный скролл по якорям, закрытие мобильного меню, появление .reveal
 */
(function () {
  'use strict';
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.registration-page .reveal').forEach(function (el) {
