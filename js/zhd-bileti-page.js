/**
 * zhd-bileti.html: плавный скролл, мобильное меню, .reveal
 */
(function () {
  'use strict';

  if (!document.body.classList.contains('zhd-bileti-page')) return;
  ...
  if (!('IntersectionObserver' in window)) {
    document.querySelectorAll('body.zhd-bileti-page .reveal').forEach(function (el) {
